...
import com.xiaodong.library.utils.ToastUtils;
...
public class NetWorkCodeException {
    ...
    public static ResponseThrowable getResponseThrowable(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            try {
                LogUtils.e("code:"+ ex.code+" "+httpException.message());
                if(ex.code>=500){
                    ToastUtils.show("code:"+ ex.code+" "+httpException.message());
                }
            } catch (Exception e1) {
                e1.printStackTrace();
            }
            ...
            try {
                ToastUtils.show("code:"+ ex.code+" "+ex.message);
            } catch (Exception e1) {
                e1.printStackTrace();
            }
            return ex;
